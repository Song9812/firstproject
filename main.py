...
st.set_page_config(page_title="MBTI 대화 가이드 (요약)", layout="centered")

st.title("💬 MBTI 성격 요약 및 대화 주제 추천")
st.write("MBTI를 선택하면 해당 유형의 성격 요약과 대화에 어울리는 주제 및 이유를 볼 수 있어요!")
...
mbti_traits = {
    ...
    "ESTJ": "⚖️ 단호하고 현실적인 성격으로, 명확하고 논리적인 대화를 선호합니다.",
...
mbti_topics_with_reasons = {
    "INTJ": [
        ...
        ("🏛️ 사회 구조 변화", "시스템에 대한 개선을 고민하는 성향이 있어 의견 나누기를 좋아합니다."),
    ...
    "ENTJ": [
        ...
        ("⏱️ 생산성 방법", "효율을 중시하는 성향이 있습니다."),
        ("🗳️ 정치 토론", "의사결정 구조와 시스템 변화에 관심이 많습니다.")
    ],
    "ENTP": [
    ...
    "ENFJ": [
        ("🗣️ 사람 이야기", "타인과의 관계, 성장 이야기에 관심이 많습니다."),
    ...
    "ISTJ": [
        ...
        ("🗂️ 계획 세우기", "사전에 준비하고 조직하는 것을 좋아합니다."),
        ("🔨 일 처리 방식", "효율적이고 현실적인 접근을 선호합니다."),
        ("🏛️ 전통 가치", "오랜 가치나 규범을 중요하게 생각합니다."),
    ...
    "ESTJ": [
        ...
        ("⚖️ 결정 내리는 법", "논리적 판단을 중시합니다."),
        ("🛠️ 현실적인 조언", "실질적인 도움을 주는 것을 좋아합니다.")
    ],
    "ESFJ": [
    ...
    "ISTP": [
        ("🛠️ 기계나 도구", "실용적이고 기술적인 주제를 좋아합니다."),
        ("🧠 논리 문제", "객관적이고 분석적인 사고를 선호합니다."),
        ("⚗️ 실험과 경험", "직접 경험하며 배우는 것을 즐깁니다."),
        ("🧊 침착한 대화", "감정보다는 사실에 집중합니다."),
        ("🏍️ 스포츠나 취미", "액티브한 활동을 좋아합니다.")
    ],
    "ISFP": [
        ("🎨 예술과 자연", "감성적이고 아름다움을 추구합니다."),
        ("💅 개인 취향", "자신만의 스타일이나 관심사를 이야기합니다."),
        ("🌈 감성적 경험", "느낌과 감정에 집중합니다."),
        ("☕ 조용한 시간", "편안한 분위기를 좋아합니다."),
        ("💖 따뜻한 이야기", "배려와 소소한 행복을 중시합니다.")
    ],
    "ESTP": [
        ("⚽ 스포츠와 액티비티", "즉흥적이고 활동적인 주제를 좋아합니다."),
        ("🧗 모험 이야기", "새로운 경험과 도전을 즐깁니다."),
        ("🤣 유머와 농담", "경쾌한 대화를 선호합니다."),
        ("🎉 사교적 만남", "사람들과 어울리는 것을 좋아합니다."),
        ("🔧 실용적인 팁", "현실적인 조언과 노하우를 공유합니다.")
    ],
    "ESFP": [
        ("🎈 파티와 이벤트", "즐거운 분위기를 만드는 활동을 좋아합니다."),
        ("🎵 음악과 춤", "감각적인 즐거움을 추구합니다."),
        ("🌟 인생 즐기기", "현재 순간을 즐기는 태도를 선호합니다."),
        ("💬 감정 표현", "감정을 자유롭게 나누는 것을 좋아합니다."),
        ("🤗 사교 활동", "사람들과의 교류를 중요시합니다.")
    ]
}
...
if selected_mbti:
    st.markdown(f"### 🧠 {selected_mbti} 성격 요약")
    st.write(mbti_traits[selected_mbti])

    st.markdown(f"### 💡 {selected_mbti} 어울리는 대화 주제 및 이유")
    for topic, reason in mbti_topics_with_reasons[selected_mbti]:
